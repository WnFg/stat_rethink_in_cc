...
- **Worked example**：对应教材中的例子（注明页码）；模型设定 + Python 代码骨架（可跑），预期输出/图
- **设计练习**（2–3 道）：贴近真实问题、可跑 Python、每题附"预期结论"供老师对照；注明它延伸/呼应教材哪一节
...
练习设计原则：理论结合实践，让学生在解决问题中理解；可延伸但要忠实反映该节教学目标；优先复用前面学过的概念；难度从模仿 worked example 到稍作迁移。
