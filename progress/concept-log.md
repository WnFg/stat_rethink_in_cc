...
| 多项式回归 / polynomial regression | mu_i=α+β₁x+β₂x²；仍是参数的线性函数；β₂<0=开口向下=重时增速放缓 | 4.5 (p123-127) | 2026-06-27 |
| 标准化 / standardizing | ws=(w-mean)/std；均值=0,std=1；① 避免数值爆炸 ② β可解释为"1SD对应的变化" | 4.5 (p124-125) | 2026-06-27 |
| 条件数 / condition number | kappa=lambda_max/lambda_min；越大优化地形越细长；标准化让kappa~1 | 4.5 (p124) | 2026-06-27 |
