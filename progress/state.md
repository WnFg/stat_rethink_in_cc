...
- **状态 Status**: active
- **当前章 Chapter**: 3 — Sampling the Imaginary
- **当前小节 Section**: 第 4 章待开始
- **下一节课焦点 Next lesson focus**: /chapter 4 生成第 4 章教案，再 /lesson 开始 §4.1
- **已生成章教案 Chapters prepared**: ch02, ch03（均过 L1+L2+L3 质检）
